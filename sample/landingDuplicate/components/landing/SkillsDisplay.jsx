        ...
        <div className="mb-6 h-full">
          ...
          <div className="space-y-8 text-start text-sm px-6">
            ...
            >
              <div className="flex items-start">
                <div className='hover:pl-2 duration-300'>
                  <h4 className="text-lg font-semibold text-[var(--pl-text)] mb-1">4 Years of Immersive Training</h4>
            ...
            <div
              ...
              className="group relative overflow-hidden rounded-lg px-4 hover:pr-3 duration-300 bg-gradient-to-r from-transparent to-[color-mix(in_oklab,var(--pl-primary)_8%,white)] glare-effect"
            >
              <div className="flex items-start">
                <div className='hover:pl-2 duration-300'>
                  <h4 className="text-lg font-semibold text-[var(--pl-text)] mb-1">Worked on Real-Time Projects</h4>
                  <p className="text-[var(--pl-text-secondary)]">
            ...
            >
              <div className="flex items-start">
                <div className='hover:pl-2 duration-300'>
                  <h4 className="text-lg font-semibold text-[var(--pl-text)] mb-1">Business Acumen Included</h4>
                  <p className="text-[var(--pl-text-secondary)]">
              ...
              <div className="flex items-start">
                <div className='hover:pl-2 duration-300'>
                  ...
                  <p className="text-[var(--pl-text-secondary)]">
                    ...
                    <span className="text-[var(--pl-text)] font-semibold inline-block underline underline-offset-1 decoration-0">
            ...
            >
              <div className="flex items-start">
                <div className='hover:pl-2 duration-300'>
                  <h4 className="text-lg font-semibold text-[var(--pl-text)] mb-1">Play-and-Plug Resources</h4>
                  <p className="text-[var(--pl-text-secondary)]">
        ...
        <div className="mb-6 h-full">
          ...
          <div className="space-y-7 text-start text-sm px-6">
            ...
            >
              <div className="flex items-start">
                <div className='hover:pl-2 duration-300'>
                  <h4 className="text-lg font-semibold text-[var(--pl-text)] mb-1">CALM IN CHAOS</h4>
                  <p className="text-[var(--pl-text-secondary)]">
            ...
            >
              <div className="flex items-start">
                <div className='hover:pl-2 duration-300'>
                  <h4 className="text-lg font-semibold text-[var(--pl-text)] mb-1">FLUENT IN GEEK AND EXEC</h4>
                  <p className="text-[var(--pl-text-secondary)]">
            ...
            >
              <div className="flex items-start">
                <div className='hover:pl-2 duration-300'>
                  <h4 className="text-lg font-semibold text-[var(--pl-text)] mb-1">SOLUTION-ORIENTED OWNERSHIP</h4>
                  <p className="text-[var(--pl-text-secondary)]">
            ...
            >
              <div className="flex items-start">
                <div className='hover:pl-2 duration-300'>
                  <h4 className="text-lg font-semibold text-[var(--pl-text)] mb-1">SOLUTIONS OVER EXCUSES</h4>
                  <p className="text-[var(--pl-text-secondary)]">
            ...
            <div
              ...
              className="group relative overflow-hidden rounded-lg hover:pr-3 duration-300 px-4 bg-gradient-to-r from-transparent to-[color-mix(in_oklab,var(--pl-primary)_8%,white)] glare-effect"
            >
              <div className="flex items-start">
                <div className='hover:pl-2 duration-300'>
                  <h4 className="text-lg font-semibold text-[var(--pl-text)] mb-1">LEARN FAST AND STAY RELEVANT</h4>
                  <p className="text-[var(--pl-text-secondary)]">
