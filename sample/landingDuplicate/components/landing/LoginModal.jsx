...
function LoginModal({ isOpen, onClose, defaultRole = 'Student', defaultMode = 'login', asPage = false }) {
  ...
  return (
    <div
      ...
      className={
        asPage
          ? "min-h-screen w-full bg-[var(--pl-bg)]"
    ...
    >
      ...
      >
        ...
        <div
          className={
            asPage
              ? "hidden md:flex items-center justify-center relative overflow-hidden bg-[radial-gradient(90%_80%_at_30%_20%,color-mix(in_oklab,var(--pl-primary)_14%,transparent),transparent_65%),linear-gradient(180deg,var(--pl-bg),var(--pl-surface-strong))]"
              : "hidden md:flex flex-col items-center justify-center w-1/2 h-full bg-transparent "
          }
        >
          {asPage && (
            <>
              <div className="pointer-events-none absolute -top-24 -left-24 h-72 w-72 rounded-full bg-[color-mix(in_oklab,var(--pl-primary)_18%,transparent)] blur-3xl" />
              <div className="pointer-events-none absolute -bottom-24 -right-24 h-72 w-72 rounded-full bg-[color-mix(in_oklab,var(--pl-accent-orange)_18%,transparent)] blur-3xl" />
            </>
          )}
          {lottieReady && (
            <dotlottie-wc
        ...
        >
          ...
          <div
            ...
            className={
              asPage
                ? "relative z-10 w-full max-w-2xl mx-auto mt-4 sm:mt-6 rounded-3xl border border-[var(--pl-border)] bg-[var(--pl-surface-strong)] shadow-sm px-5 sm:px-8 py-7 sm:py-8"
            ...
            {asPage && (
              <div className="mb-6 flex items-center justify-between">
                <button
                  ...
                  title="Home"
                  className="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-[var(--pl-border)] bg-[var(--pl-surface-strong)] shadow-sm hover:bg-black/5 transition"
                >
                  <Home size={18} className="text-[var(--pl-text)]" />
                </button>
                <div />
              </div>
            )}

            <h2 className="text-xl font-bold mb-6 text-center text-[var(--pl-text)] uppercase" style={{ fontFamily: '"Josefin Sans", sans-serif' }}>
              {mode === 'login' && 'Sign in'}
