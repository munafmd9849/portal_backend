    ...
    <section ref={sectionRef} className="relative w-full bg-[var(--pl-bg)]">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 py-16 relative">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-lg sm:text-xl text-[var(--pl-text-secondary)] max-w-3xl mx-auto">
            Meet the people who help students prepare, connect, and convert opportunities into offers.
          </p>
        </div>
