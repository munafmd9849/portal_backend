...
const StudentFooter = ({ onLoginOpen, onContactTeam, onMeetDevTeam, onPlacementPolicy }) => {
    ...
    return (
        <footer className="text-white py-4 md:py-5 relative overflow-hidden mt-6 md:mt-10 rounded-lg min-w-0" style={{ background: 'linear-gradient(135deg, #0a0a1a 0%, #1a1a3a 50%, #2a2a5a 100%)' }}>
            <div className="px-4 md:px-[8%] grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-10">

                {/* Brand Section */}
                <div className="flex flex-col mt-4 md:mt-6 items-start">
                    <img
                        src={brandLogo}
                        alt="PW IOI Logo"
                        className="w-28 md:w-44 mb-3 md:mb-5 filter brightness-0 invert"
                    />
                    
                    {/* Social Media Icons */}
                    <div className="flex gap-6 md:gap-12 ml-0 md:ml-1">
                        <a
                            href={linkedinLink}
                            target='_blank'
                ...
                <div className="flex flex-col mt-2 md:mt-4">
                    <h3 className="text-lg md:text-2xl text-gray-200 font-semibold mb-3 md:mb-5 relative inline-block after:content-[''] after:absolute after:bottom-[-8px] after:left-0 after:w-12 after:h-0.5 after:bg-gray-400 after:transition-all after:duration-300 hover:after:w-full">
                        Quick Links
                    </h3>
                    <a
                        href={policyDoc}
                ...
                <div className="flex flex-col mt-2 md:mt-4">
                    ...
                    <div className="space-y-2 md:space-y-3 mb-4 md:mb-6">
                        ...
                        >
                            ...
                            <span className="text-sm md:text-base break-all">placement@pwioi.edu.in</span>
                        </a>
                        <a
            ...
            <div className="mt-4 md:mt-5 pt-2 md:pt-3 border-t border-white/30 text-gray-400 text-xs md:text-sm flex flex-col items-center gap-1 px-2">
                <div className='font-caveat text-lg md:text-2xl text-gray-300 text-center'>
                ...
                <div className="w-full flex items-center justify-center gap-2">
                    ...
                    <span className="text-center text-xs md:text-sm">© {new Date().getFullYear()} PW IOI - Placement Cell. All Rights Reserved.</span>
                    <span className="hidden sm:block h-px w-12 bg-gray-400" />
                </div>
            </div>
        </footer>
