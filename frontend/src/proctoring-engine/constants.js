...
export const EVENT_SCREENSHOT_VIOLATIONS = new Set([
  ...
  ProctoringViolationType.SCREEN_SHARE_ATTEMPT,
...
export const VIOLATION_SEVERITY = Object.freeze({
  ...
  [ProctoringViolationType.MULTI_MONITOR]: 'HIGH',
  [ProctoringViolationType.SCREEN_SHARE_ATTEMPT]: 'CRITICAL',
  [ProctoringViolationType.SCREEN_MIRRORING]: 'CRITICAL',
