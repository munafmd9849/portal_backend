...
const DashboardHome = ({ 
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case 'applied':
        return 'text-[var(--pl-primary)] bg-[color-mix(in_oklab,var(--pl-primary)_10%,white)]';
      case 'shortlisted':
        return 'text-[var(--pl-warning)] bg-[color-mix(in_oklab,var(--pl-warning)_12%,white)]';
      case 'selected':
        return 'text-[var(--pl-success)] bg-[color-mix(in_oklab,var(--pl-success)_12%,white)]';
      case 'rejected':
        return 'text-[var(--pl-danger)] bg-[color-mix(in_oklab,var(--pl-danger)_12%,white)]';
      default:
        return 'text-[var(--pl-text-secondary)] bg-[color-mix(in_oklab,var(--pl-text-muted)_12%,white)]';
    }
  };
  ...
  return (
    <div className="space-y-4">
      {error && (
        <div className="bg-[color-mix(in_oklab,var(--pl-danger)_10%,white)] border border-[color-mix(in_oklab,var(--pl-danger)_35%,white)] rounded-lg p-3">
          <p className="text-[var(--pl-danger)] text-sm">{error}</p>
        </div>
      )}
