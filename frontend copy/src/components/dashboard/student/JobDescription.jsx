    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2">
        <div className="bg-white rounded-xl shadow-2xl p-6 text-center">
          ...
          <button
            onClick={onClose}
            className="px-4 py-2 bg-[var(--pl-text-secondary)] text-white rounded-md hover:bg-[var(--pl-text)]"
          >
            Close
          </button>
        </div>
      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-6xl h-[90vh] overflow-hidden flex flex-col">
        ...
        {loading && (
          <div className="absolute inset-0 bg-white bg-opacity-90 flex items-center justify-center z-10">
            <div className="flex flex-col items-center">
              <Loader className="h-8 w-8 animate-spin text-[var(--pl-primary)] mb-2" />
              <span className="text-[var(--pl-text-secondary)]">Loading job details...</span>
            </div>
          </div>
        )}
          ...
          <div className="absolute inset-0 bg-white bg-opacity-90 flex items-center justify-center z-10">
            <div className="text-center">
              ...
              <button
                ...
                className="px-4 py-2 bg-[var(--pl-primary)] text-white rounded-md hover:bg-[var(--pl-link-hover)]"
              >
                Retry
              </button>
            </div>
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[var(--pl-text)]">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-md text-[var(--pl-text-muted)] hover:text-[var(--pl-text-secondary)] transition-colors"
          >
            <FaTimes size={24} />
          </button>
        </div>
        ...
        <div className="border-b">
          <div className="flex px-6">
            <button
              className={`px-4 py-3 font-medium text-sm ${activeTab === "overview" ? "text-[var(--pl-primary)] border-b-2 border-[var(--pl-primary)]" : "text-[var(--pl-text-muted)] hover:text-[var(--pl-text)]"}`}
              onClick={() => setActiveTab("overview")}
            >
              Overview
            </button>
            <button
              className={`px-4 py-3 font-medium text-sm ${activeTab === "requirements" ? "text-[var(--pl-primary)] border-b-2 border-[var(--pl-primary)]" : "text-[var(--pl-text-muted)] hover:text-[var(--pl-text)]"}`}
              onClick={() => setActiveTab("requirements")}
            >
              Requirements
            </button>
            <button
              className={`px-4 py-3 font-medium text-sm ${activeTab === "process" ? "text-[var(--pl-primary)] border-b-2 border-[var(--pl-primary)]" : "text-[var(--pl-text-muted)] hover:text-[var(--pl-text)]"}`}
          ...
          {activeTab === "overview" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-[var(--pl-surface)] p-4 rounded-lg">
                  <div className="flex items-center gap-2 text-[var(--pl-text-secondary)] mb-1">
                    <FaBriefcase className="text-[var(--pl-primary)]" />
