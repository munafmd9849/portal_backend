...
const AUDIENCES = [
  {
    ...
    bullets: ["AI-ready resume structure", "Interview practice and assessments", "Apply to relevant jobs faster"],
    accent: "from-blue-900 to-indigo-700",
  },
  {
    title: "Colleges",
    subtitle: "Manage cohorts and improve placement rates",
    bullets: ["Student database + progress tracking", "Centralized placement workflows", "Reporting and outcome analytics"],
    accent: "from-gray-900 to-gray-700",
  },
  {
    title: "Employers",
    subtitle: "Discover job-ready talent at scale",
    bullets: ["Early talent pipeline", "Faster shortlisting", "Structured screening and hiring"],
