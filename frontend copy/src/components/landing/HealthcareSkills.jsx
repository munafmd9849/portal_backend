            ...
            >
              <div className="flex items-start">
                <div className='hover:pl-2 duration-300'>
                  ...
                  <p className="text-gray-700"><span className="underline decoration-black font-semibold">40% faster response times</span> during code blues and rapid responses compared to average new hires.</p>
                </div>
              </div>
            </div>
            <div
            ...
            >
              <div className="flex items-start">
                <div className='hover:pl-2 duration-300'>
                  ...
                  <p className="text-gray-700"><span className="underline decoration-black font-semibold">30% fewer safety incidents</span> due to proactive risk identification and mitigation.</p>
                </div>
              </div>
            </div>
            <div
            ...
            >
              <div className="flex items-start">
                <div className='hover:pl-2 duration-300'>
                  ...
                  <p className="text-gray-700"><span className="underline decoration-black font-semibold">50% faster protocol adoption</span> when implementing new clinical guidelines or technology.</p>
                </div>
              </div>
            </div>
          </div>
