...
const ResumeBuilder = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          <Loader className="animate-spin mx-auto mb-4 text-[var(--pl-primary)]" size={48} />
          <p className="text-[var(--pl-text-secondary)]">Loading your profile...</p>
        </div>
      </div>
    );
  }
    ...
    try {
      ...
      return (
        <div className="text-center py-8 text-red-500">
          ...
          <p className="text-sm text-[var(--pl-text-muted)] mt-2">{error.message}</p>
        </div>
      );
    }
  };
  ...
  return (
    <div className="w-full space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-[var(--pl-primary)] to-[var(--pl-primary)] rounded-xl p-6 text-white shadow-lg">
      ...
      <div className="bg-[var(--pl-surface-strong)] rounded-xl border-2 border-[var(--pl-border)] p-3 shadow-sm">
          ...
          <button
            ...
            className={`flex-1 min-w-[180px] flex items-center justify-center gap-3 px-6 py-4 rounded-xl transition-all font-semibold cursor-pointer ${
              activeMode === 'buildResume'
                ? 'bg-[var(--pl-primary)] text-white shadow-lg'
                : 'bg-[var(--pl-surface)] text-[var(--pl-text)] hover:bg-[var(--pl-primary)]/10 hover:text-[var(--pl-primary)] hover:border-[var(--pl-primary)]/30 border border-[var(--pl-border)]'
            }`}
          >
            <FileText size={22} />
                ...
                return (
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 px-2 py-1.5 rounded-lg transition-all text-sm font-medium cursor-pointer whitespace-nowrap ${
                      isActive
                        ? 'bg-[var(--pl-primary)] text-white shadow-md'
                        : 'bg-[var(--pl-surface)] text-[var(--pl-text)] hover:bg-[var(--pl-primary)]/10 hover:text-[var(--pl-primary)] hover:border-[var(--pl-primary)]/30 border border-[var(--pl-border)]'
                    }`}
                  >
                    <Icon size={14} />
      ...
      {activeMode === 'buildResume' && (
        <>
          ...
          {activeSection !== 'preview' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-[var(--pl-surface-strong)] rounded-xl border-2 border-[var(--pl-border)] p-8 shadow-sm">
        {/* Personal Info */}
        {activeSection === 'personal' && (
          <div className="space-y-6">
            <div className="flex items-center justify-between border-b border-[var(--pl-border)] pb-4">
              <h3 className="text-2xl font-bold text-[var(--pl-text)] flex items-center gap-3">
                <div className="bg-[var(--pl-primary)]/20 p-2 rounded-lg">
                  <User size={24} className="text-[var(--pl-primary)]" />
                </div>
                Personal Information
              </h3>
              <div className="text-sm text-[var(--pl-text-muted)] bg-[var(--pl-surface)] px-3 py-1 rounded-lg">
                <span className="text-red-500">*</span> Required fields
              </div>
            </div>
            <div className="bg-[var(--pl-primary)]/10 border border-[var(--pl-primary)]/30 rounded-lg p-4 mb-4">
              <div className="flex items-start gap-3">
                <Info size={20} className="text-[var(--pl-primary)] mt-0.5 flex-shrink-0" />
                <div className="text-sm text-[var(--pl-primary)]">
            ...
            <div className="space-y-5">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-[var(--pl-border)] rounded-lg hover:border-[var(--pl-primary)]/50 focus:ring-2 focus:ring-[var(--pl-primary)] focus:border-[var(--pl-primary)] focus:outline-none transition-all cursor-text"
              ...
              <div className="space-y-1">
                <label className="block text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
                  <Github size={16} className="text-[var(--pl-text)]" />
                  GitHub
                </label>
                <input
                  type="url"
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 border-2 border-[var(--pl-border)] rounded-lg hover:border-[var(--pl-primary)]/50 focus:ring-2 focus:ring-[var(--pl-primary)] focus:border-[var(--pl-primary)] focus:outline-none transition-all resize-none cursor-text"
                placeholder="Write a brief professional summary highlighting your key skills and experience (2-3 sentences recommended)"
              />
              <p className="text-xs text-[var(--pl-text-muted)] mt-1">This summary will appear at the top of your resume</p>
            </div>
            <div className="flex justify-end pt-4 border-t border-[var(--pl-border)]">
              <button
                onClick={handleSavePersonal}
                disabled={saving}
                className="flex items-center gap-2 bg-[var(--pl-primary)] text-white px-8 py-3 rounded-lg hover:bg-[var(--pl-link-hover)] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer font-semibold shadow-md hover:shadow-lg transition-all"
              >
        ...
        {activeSection === 'education' && (
          <div className="space-y-6">
            <div className="flex items-center justify-between border-b border-[var(--pl-border)] pb-4">
              <h3 className="text-2xl font-bold text-[var(--pl-text)] flex items-center gap-3">
                <div className="bg-[var(--pl-accent-purple)]/20 p-2 rounded-lg">
                  <GraduationCap size={24} className="text-[var(--pl-accent-purple)]" />
                </div>
                Education
              </h3>
              <div className="text-sm text-[var(--pl-text-muted)] bg-[var(--pl-surface)] px-3 py-1 rounded-lg">
            ...
            <div className="bg-[var(--pl-primary)]/10 border border-[var(--pl-primary)]/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                <Info size={20} className="text-[var(--pl-primary)] mt-0.5 flex-shrink-0" />
                <div className="text-sm text-[var(--pl-primary)]">
                  <p className="font-semibold mb-1">💡 Quick Tip:</p>
            ...
            <div className="bg-gradient-to-br from-[var(--pl-surface)] to-[var(--pl-primary)]/10 rounded-xl p-6 border-2 border-dashed border-[var(--pl-border)]">
              <h4 className="font-bold text-lg mb-4 flex items-center gap-2">
                <Plus size={20} className="text-[var(--pl-primary)]" />
                Add New Education
              </h4>
              <div className="space-y-6">
                <div className="space-y-1">
                  <label className="block text-sm font-semibold text-[var(--pl-text)] mb-2">
                ...
                <div className="space-y-1">
                  <label className="block text-sm font-semibold text-[var(--pl-text)] mb-2">Start Year</label>
                  <input
                    type="number"
                    placeholder="YYYY"
                ...
                <div className="space-y-1">
                  <label className="block text-sm font-semibold text-[var(--pl-text)] mb-2">End Year</label>
                  <input
                    type="number"
                ...
                <div className="space-y-1">
                  <label className="block text-sm font-semibold text-[var(--pl-text)] mb-2">CGPA</label>
                  <input
                    type="number"
                    step="0.01"
                    placeholder="e.g., 8.5"
            ...
            <div className="space-y-3">
              {student?.education?.map((edu) => (
                editingEducation?.id === edu.id ? (
                  <div key={edu.id} className="bg-[var(--pl-primary)]/10 rounded-lg p-4 border border-[var(--pl-primary)]/30">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-[var(--pl-border)] rounded-lg"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-[var(--pl-text)] mb-1">
                      ...
                      <input
                        ...
                        className="px-3 py-2 border border-[var(--pl-border)] rounded-lg cursor-text"
                      />
                      <input
                        type="number"
                    ...
                    <div className="flex gap-2 mt-3">
                      <button
                        ...
                        className="bg-[var(--pl-primary)] text-white px-4 py-2 rounded-lg hover:bg-[var(--pl-link-hover)] hover:shadow-md transition-all cursor-pointer"
                      >
                        Save
                      </button>
                      <button
                        onClick={() => setEditingEducation(null)}
                        className="bg-[var(--pl-disabled)] text-[var(--pl-text)] px-4 py-2 rounded-lg hover:bg-[var(--pl-disabled)]/80 hover:shadow-md transition-all cursor-pointer"
                      >
                        Cancel
                      </button>
                    </div>
                  ...
                  <div key={edu.id} className="bg-[var(--pl-surface)] rounded-lg p-4 flex justify-between items-start">
                    <div>
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="text-[var(--pl-primary)] hover:text-[var(--pl-link-hover)] hover:scale-110 transition-all cursor-pointer"
                      >
                        <Edit2 size={18} />
                      </button>
                      <button
        ...
        {activeSection === 'experience' && (
          <div className="space-y-6">
            <div className="flex items-center justify-between border-b border-[var(--pl-border)] pb-4">
              <h3 className="text-2xl font-bold text-[var(--pl-text)] flex items-center gap-3">
                <div className="bg-[var(--pl-primary)]/20 p-2 rounded-lg">
                  <Briefcase size={24} className="text-[var(--pl-primary)]" />
                </div>
                Work Experience
              </h3>
              <div className="text-sm text-[var(--pl-text-muted)] bg-[var(--pl-surface)] px-3 py-1 rounded-lg">
            ...
            <div className="bg-gradient-to-br from-[var(--pl-surface)] to-[var(--pl-primary)]/10 rounded-xl p-6 border-2 border-dashed border-[var(--pl-border)]">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-1">
                  <label className="block text-sm font-semibold text-[var(--pl-text)] mb-2">Start Date</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1">
                  <label className="block text-sm font-semibold text-[var(--pl-text)] mb-2">End Date</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1">
                  <label className="block text-sm font-semibold text-[var(--pl-text)] mb-2">Job Description</label>
                  <textarea
            ...
            <div className="space-y-3">
              {student?.experiences?.map((exp) => (
                editingExperience?.id === exp.id ? (
                  <div key={exp.id} className="bg-[var(--pl-primary)]/10 rounded-lg p-4 border border-[var(--pl-primary)]/30">
                    <div className="space-y-3">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <input
                          type="text"
                  ...
                  <div key={exp.id} className="bg-[var(--pl-surface)] rounded-lg p-4 flex justify-between items-start">
                    <div>
                      <h4 className="font-semibold">{exp.title} at {exp.company}</h4>
                      <p className="text-sm text-[var(--pl-text-secondary)]">{exp.start} - {exp.end || 'Present'}</p>
                      {exp.description && <p className="text-sm text-[var(--pl-text)] mt-1">{exp.description}</p>}
                    </div>
                    <div className="flex gap-2">
                      <button
