...
export async function seedUsers() {
  ...
  if (CREDENTIALS.admin.email.toLowerCase() !== CREDENTIALS.superAdmin.email.toLowerCase()) {
    ...
    console.log(`   ADMIN uses SUPER_ADMIN account (${CREDENTIALS.superAdmin.email})`);
  }
  ...
  const enrollmentId = 'ENR-SEED-001';
